...
function createInput(id, attributes, textarea, button) {
  ...
  const inputClasses = classNames(
    "block w-full rounded-md border-0  py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-customOrange text-sm leading-6"
  );
